...
ALTER TABLE GERER ENGINE=InnoDB CHARSET=utf8 COLLATE=utf8_general_ci;
...
ALTER TABLE RENNE 
ADD CONSTRAINT FK_TRAINEAU_RENNE FOREIGN KEY (Id_TRAINEAU) REFERENCES TRAINEAU(Id_TRAINEAU);

ALTER TABLE TOURNEE 
ADD CONSTRAINT FK_LUTIN_TOURNEE FOREIGN KEY(Id_Lutin) REFERENCES LUTIN(Id_Lutin),
ADD CONSTRAINT FK_TRAINEAU_TOURNEE FOREIGN KEY(Id_TRAINEAU) REFERENCES TRAINEAU(Id_TRAINEAU);

ALTER TABLE CADEAU 
ADD CONSTRAINT FK_CADEAU FOREIGN KEY (Id_TRAINEAU) REFERENCES TRAINEAU(Id_TRAINEAU);

ALTER TABLE VOEUX 
ADD CONSTRAINT FK_CADEAU_VOEUX FOREIGN KEY(Id_CADEAU) REFERENCES CADEAU(Id_CADEAU),
ADD CONSTRAINT FK_ENFANT_VOEUX FOREIGN KEY(Id_ENFANT) REFERENCES ENFANT(Id_ENFANT); 

ALTER TABLE GERER 
ADD CONSTRAINT FK_LUTIN_GERER FOREIGN KEY(Id_Lutin) REFERENCES LUTIN(Id_Lutin),
ADD CONSTRAINT FK_TRAINEAU_GERER FOREIGN KEY(Id_TRAINEAU) REFERENCES TRAINEAU(Id_TRAINEAU); 
