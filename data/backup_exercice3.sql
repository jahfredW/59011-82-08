...
--
-- Temporary table structure for view `enseignants_matieres`
--

DROP TABLE IF EXISTS `enseignants_matieres`;
/*!50001 DROP VIEW IF EXISTS `enseignants_matieres`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `enseignants_matieres` AS SELECT 
 1 AS `idEnseignant`,
 1 AS `nomEnseignant`,
...
--
-- Final view structure for view `enseignants_matieres`
--
...
/*!50001 VIEW `enseignants_matieres` AS select `e`.`idEnseignant` AS `idEnseignant`,`e`.`nomEnseignant` AS `nomEnseignant`,`e`.`prenomEnseignant` AS `prenomEnseignant`,`e`.`fonctionEnseignant` AS `fonctionEnseignant`,`e`.`adresseEnseignant` AS `adresseEnseignant`,`e`.`villeEnseignant` AS `villeEnseignant`,`e`.`codePostalEnseignant` AS `codePostalEnseignant`,`e`.`telephoneEnseignant` AS `telephoneEnseignant`,`e`.`dateNaissanceEnseignant` AS `dateNaissanceEnseignant`,`e`.`dateEmbaucheEnseignant` AS `dateEmbaucheEnseignant`,`m`.`idMatiere` AS `idMatiere`,`m`.`nomMatiere` AS `nomMatiere`,`m`.`idModule` AS `idModule`,`m`.`coefficientMatiere` AS `coefficientMatiere`,`f`.`annee` AS `annee` from ((`enseignants` `e` join `faire_cours` `f` on((`e`.`idEnseignant` = `f`.`idEnseignant`))) join `matieres` `m` on((`m`.`idMatiere` = `f`.`idMatiere`))) */;
...
-- Dump completed on 2023-10-25 13:28:24
